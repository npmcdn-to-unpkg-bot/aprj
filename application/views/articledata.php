...
echo "<a id=\"gplusshare\" href=\"https://plus.google.com/share?url=$base\" onclick=\"javascript:window.open(this.href,
  '', 'menubar=no, toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;\"><img
        droparea=\"https://www.gstatic.com/images/icons/gplus-64.png\" alt=\"Share on Google+\" hidden/></a>";
...
if($alldata[0]["image"]!=""){
    ...
    echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnail\" alt=\"image0\"></a>";


}
if($alldata[0]["image1"]!=""){
    $thumbnail=str_replace ( "\\" , "/" , $alldata[0]["image1"] );
    echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnail\" alt=\"image1\"></a>";


}
if($alldata[0]["image2"]!=""){
    $thumbnail=str_replace ( "\\" , "/" , $alldata[0]["image2"] );
    echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnail\" alt=\"image2\"></a>";


}
if($alldata[0]["image3"]!=""){
//    echo "<img droparea=".$alldata[0]["image3"].">";
    $thumbnail=str_replace ( "\\" , "/" , $alldata[0]["image3"] );
    echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnail\" alt=\"image3\"></a>";

}
if($alldata[0]["image4"]!=""){
//    echo "<img droparea=".$alldata[0]["image3"].">";
    $thumbnail=str_replace ( "\\" , "/" , $alldata[0]["image4"] );
    echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnail\" alt=\"image4\"></a>";
...
//    echo "<img droparea=".$alldata[0]["image3"].">";
    ...
    $thumbnailvideo=str_replace ( "\\" , "/" , $alldata[0]["video"] );
    //echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnail\" alt=\"Trees\"></a>";
    echo "<a href=\"$thumbnail\"><img droparea=\"$thumbnailvideo\" alt=\"Video\"></a>";
}
...
?>
    ...
    <a href="images/Big_Buck_Bunny.mp4"><img droparea="images/Big_Buck_Bunny.jpg" alt="Big Buck Bunny, Copyright Blender Foundation"></a>

    <!-- Add Youtube video to Gallery
    <a href="http://www.youtube.com/embed/YE7VzlLtp-4"><img droparea="http://img.youtube.com/vi/YE7VzlLtp-4/2.jpg" alt="Youtube Video"></a>

    <!-- Add Vimeo video to Gallery
    <a href="https://player.vimeo.com/video/1084537?title=0&amp;byline=0&amp;portrait=0"><img droparea="images/Big_Buck_Bunny.jpg" alt="Vimeo Video"></a>
-->
