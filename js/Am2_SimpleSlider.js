...
(function ($) {
    ...
    jQuery.fn.Am2_SimpleSlider = function () {
        //popup div
 //$div = $('<div class="product-gallery-popup"> <div class="popup-overlay"></div> <div class="product-popup-content"> <div class="product-image "> <img style="width:95%;margin-top:3%;"  id="gallery-img" droparea="" alt="" /> <div class="gallery-nav-btns"> <a id="nav-btn-next" class="nav-btn next" ></a> <a id="nav-btn-prev" class="nav-btn prev" ></a></div> </div><div class="product-information"> <p class="product-desc"></p></div> <div class="clear"></div><a href="#" class="cross">X</a></div></div>').appendTo('body');
	   ...
	   $div = $('<div class="product-gallery-popup"> '+
        ...
        $(this).click(function () {
           ...
           // $('.product-popup-content .product-image img').attr('droparea', $(this).find('img').attr('droparea'));
